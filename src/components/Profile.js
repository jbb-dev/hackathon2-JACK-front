...
const Profile = (props) => {
  ...
  return (
    <Container>
      <Header arrow="true" title="Mon profil" pathName="/home"/>
        ...
        <table>
          ...
          <tr className="valeur">
            {modif ? (
              <input
                type="text"
                value={modifiedProfile.mutuelle}
                onChange={(e) =>
                  setModifiedProfile({
                    ...modifiedProfile,
